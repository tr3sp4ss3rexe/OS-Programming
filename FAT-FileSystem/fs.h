// fs.h is the header file for the FS class. It contains the class definition and the function prototypes.
#include <iostream>
#include <cstdint>
#include <cstring>
#include <string>
...
private:
    ...
    // Root directory init
    dir_entry root_dir[ROOT_DIR_SIZE];
...
public:
    ...
    int resolvePathToDirectory(const string &path);
};
